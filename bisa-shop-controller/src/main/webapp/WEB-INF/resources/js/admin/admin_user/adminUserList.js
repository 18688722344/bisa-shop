$(document).ready(function () {
    ...
    layui.use(['form', 'table', 'element'], function () {
        ...
        //有关表格的重载参考layui数据表格
        table.render({
            elem: '#adminUserlist', //指定原始表格元素选择器（推荐id选择器）
            height: 400, //容器高度
            cols: [
                [ //标题栏
                    /*id是隐藏的*/
            ...
            data: [
                {
                    "id": 10000,
                    "username": "小叶",
                    "phonenum": "13395684256",
                    "email": "13395684256@bisa.hk.com",
                    "weixinnum": "bisasupper",
                    "registertime": "2017/10/12 9:49:11",
                    "lastlogintime": "2017/12/20 9:49:11",
                    "state": "正常",
                },
                {
                    "id": 10002,
