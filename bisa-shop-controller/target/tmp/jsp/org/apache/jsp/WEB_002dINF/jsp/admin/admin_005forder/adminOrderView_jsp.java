 ...
 * Generated at: 2019-01-14 07:42:16 UTC
...
public final class adminOrderView_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("    <title>碧沙康健_查看订单</title>\r\n");
      out.write("    <!-- base -->\r\n");
      ...
      out.write("    <![endif]-->\r\n");
      out.write("    <script>\r\n");
      out.write("\t\tvar orderclosed = \"");
      out.print(PayStatus.close.getValue());
      out.write("\";  \r\n");
      out.write("\t\tvar unpaid = \"");
      out.print(PayStatus.unpaid.getValue());
      out.write("\";  \r\n");
      out.write("\t    var paid = \"");
      ...
      out.write("\";\r\n");
      out.write("\t    var apply_for = \"");
      out.print(AfterSalesStatus.apply_for.getValue());
      out.write("\";\r\n");
      out.write("\t    var apply_for_ing = \"");
      out.print(AfterSalesStatus.apply_for_ing.getValue());
      out.write("\";\r\n");
      out.write("\t    var service_success = \"");
      out.print(AfterSalesStatus.service_success.getValue());
      out.write("\";\r\n");
      out.write("\t    var service_fail = \"");
      out.print(AfterSalesStatus.service_fail.getValue());
      out.write("\";\r\n");
      out.write("\t    var logistics_success = \"");
      out.print(AfterSalesStatus.logistics_success.getValue());
      out.write("\";\r\n");
      out.write("\t    var logistics_fail = \"");
      out.print(AfterSalesStatus.logistics_fail.getValue());
      out.write("\";\r\n");
      ...
      out.write("\";\r\n");
      out.write("\t    var complete = \"");
      out.print(AfterSalesStatus.complete.getValue());
      out.write("\";\r\n");
      out.write("\t    var cancel = \"");
      out.print(AfterSalesStatus.cancel.getValue());
      out.write("\";\r\n");
      out.write("\t</script> \r\n");
      out.write("\t<script type=\"text/html\" id=\"traStatusTpl\">\r\n");
      out.write("\t\t{{#  if(d.tra_status == orderclosed){ }}  \r\n");
      out.write("         已取消\r\n");
      out.write("        {{#  } }}\r\n");
      out.write("\t\t{{#  if(d.tra_status == unpaid){ }}  \r\n");
      out.write("        待付款 \r\n");
      out.write("        {{#  } }}\r\n");
      ...
      out.write("        {{#  } }}\r\n");
      out.write("\t</script>\r\n");
      out.write("\t<script type=\"text/html\" id=\"orderEmailTpl\">\r\n");
      out.write("\t\t{{#  if(d.orderEmail == \"\"){ }}  \r\n");
      out.write("         ----------\r\n");
      out.write("        {{#  } else{ }}\r\n");
      out.write("\t\t\t{{  d.orderEmail }}\r\n");
      out.write("\t\t{{#  } }}\r\n");
      out.write("\t</script>\r\n");
      out.write("\t<script type=\"text/html\" id=\"logisticsAccountTpl\">\r\n");
      out.write("\t\t{{#  if(d.logisticsAccount == \"\"){ }}  \r\n");
      out.write("         ----------\r\n");
      out.write("        {{#  } else{ }}\r\n");
      out.write("\t\t\t{{  d.logisticsAccount }}\r\n");
      out.write("\t\t{{#  } }}\r\n");
      out.write("\t</script>\r\n");
      ...
      out.write("         --------- \r\n");
      out.write("       {{#  } }}\r\n");
      out.write("       {{#  if(d.after_sale_apply == apply_for){ }}  \r\n");
      out.write("          待申请\r\n");
      out.write("       {{#  } }}\r\n");
      out.write("       {{#  if(d.after_sale_apply == apply_for_ing){ }}  \r\n");
      out.write("<span style=\"color: #9900ff\">申请中</span>\r\n");
      out.write("       {{#  } }}\r\n");
      out.write("       {{#  if(d.after_sale_apply == service_success){ }}  \r\n");
      out.write("<span style=\"color: red\">客服审核  成功</span>\r\n");
      out.write("       {{#  } }}\r\n");
      out.write("       {{#  if(d.after_sale_apply == service_fail){ }}  \r\n");
      out.write("<span style=\"color: #0000EE\">客服审核  失败</span>\r\n");
      out.write("       {{#  } }}\r\n");
      out.write("       {{#  if(d.after_sale_apply == logistics_success){ }}  \r\n");
      out.write("<span style=\"color: red\">物流审核 成功</span>\r\n");
      out.write("       {{#  } }}\r\n");
      out.write("       {{#  if(d.after_sale_apply == logistics_fail){ }}  \r\n");
      out.write("<span style=\"color: #0000EE\">物流审核 失败</span>\r\n");
      out.write("       {{#  } }}\r\n");
      out.write("       {{#  if(d.after_sale_apply == finance_success){ }} \r\n");
      ...
      out.write("       {{#  } }}\r\n");
      out.write("       {{#  if(d.after_sale_apply == refund_success){ }} \r\n");
      out.write("<span style=\"color: red\">退款成功</span> \r\n");
      out.write("       {{#  } }}\r\n");
      out.write("       {{#  if(d.after_sale_apply == refund_failure){ }}  \r\n");
      out.write("<span style=\"color: #0000EE\">退款失败</span>\r\n");
      out.write("       {{#  } }}\r\n");
      out.write("       {{#  if(d.after_sale_apply == complete){ }}  \r\n");
      out.write("<span style=\"color: blue\">已完成</span>\r\n");
      out.write("       {{#  } }}\r\n");
      out.write("       {{#  if(d.after_sale_apply == cancel){ }}  \r\n");
      out.write("            已取消\r\n");
      out.write("       {{#  } }}\r\n");
      out.write("   </script>\r\n");
      out.write("</head>\r\n");
      ...
      out.write("                                        <option value=\"1\">订单号</option>\r\n");
      out.write("                                        <option value=\"2\">运单号</option>\r\n");
      out.write("                                    </select>\r\n");
      out.write("                                </div>\r\n");
      out.write("                                <div class=\"layui-inline\">\r\n");
      ...
      out.write("                </p>\r\n");
      out.write("                <div class=\"clear pd-15 bg-fafafa bor bor-col-e8ebf2 min-w-1200\">\r\n");
      out.write("                    <table id=\"orderlist\" lay-filter=\"test\"></table>\r\n");
      out.write("                </div>\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("        \r\n");
      ...
      out.write("    <script src=\"resources/js/admin/admin_order/adminOrderView.js\"></script>\r\n");
      out.write("</body>\r\n");
      out.write("\r\n");
      out.write("</html>");
