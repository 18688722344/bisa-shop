...
<head>
	...
	<script type="text/javascript">
		...
		var name_146 = "<spring:message code='name_146'/>";
...
<body>
            ...
            <div class="clear pt-20 pl-20 pr-20 bg-f5f5f5 pb-45 full-w cur-d">
                ...
                <div class="clear mt-20 pt-20 pb-20 line-h-30 cur-d bor bor-b bor-col-B2B2B2">
                 ...
                 <div class="clear pt-20 pb-20 line-h-30 cur-d bor bor-b bor-col-B2B2B2">
                    <span class="f-18 col-252525 family-h dis-ib mr-30">
                        <spring:message code="name751"/>
                    </span>
                    <div>
	                    <span class="f-14 col-252525 family-h dis-ib ml-30 mr-20"><spring:message code="name752"/></span>
	                    <input id="email" class="pl-5 w-200" type="text" placeholder='<spring:message code="name753"/>'><br>
                    </div>
                 </div>
                <div class="clear pt-20 f-18 pb-20 line-h-30 cur-d bor bor-b bor-col-B2B2B2">
                    <span class="col-252525 family-h dis-ib mr-30">
                        	<spring:message code="name117"/>
                    </span>
					<!--  订单已满足包邮条件 -->
                    <span class="f-14 col-309DE2 family-h dis-n free-post-div">
                       	<spring:message code="name754"/>
                    </span>
                    <div class="mt-10 post-method-div">
                    	<div class="ml-30 mr-20 mb-10">
	                    <select class="f-16" name="choose" id="choose">
							<option value="1" selected="selected"><spring:message code="name755"/></option>
							<option value="2"><spring:message code="name756"/></option>
							<option value="3"><spring:message code="name757"/></option>
							<option value="4"><spring:message code="name758"/></option>
							<option value="5"><spring:message code="name759"/></option>
							<option value="6"><spring:message code="name760"/></option>
							<option value="7"><spring:message code="name761"/></option>
							<option value="8"><spring:message code="name762"/></option>
						</select>
						</div>
						<div class="post-account-div dis-n">
							<span class="f-14 col-ff0000 family-h mt-10 ml-30 mr-20"><spring:message code="name763"/></span>
		                    <input class="pl-5 w-200" type="text" id="postAccount" placeholder='<spring:message code="name764"/>'><br>
						</div>
					</div>
					<div class="mt-10">
						<span class="f-14 col-252525 family-h mr-30"><spring:message code="name765"/><br> </span>
			        	<span class="f-12 col-252525 family-h ml-30"><spring:message code="name766"/><br></span>
			        	<span class="f-14 col-252525 family-h"><spring:message code="name767"/><br></span>
			        	<span class="f-12 col-252525 family-h ml-30"><spring:message code="name768"/><br></span>
			        	<span class="f-14 col-252525 family-h"><spring:message code="name769"/><br></span>
			         	<span class="f-12 col-252525 family-h ml-30"><spring:message code="name770"/><br></span>
			          	<span class="f-14 col-252525 family-h"><spring:message code="name771"/><br> </span>
			          	<span class="f-12 col-252525 family-h ml-30"><spring:message code="name772"/><br></span>
			         	<span class="f-14 col-252525 family-h"><spring:message code="name773"/><br> </span>
			          	<span class="f-12 col-252525 family-h ml-30"><spring:message code="name774"/><br></span>
			         </div>
                 </div>
                </div>
               ...
               <div class="clear full-w pt-20 pb-20 bor bor-t bor-col-B2B2B2">
                   <div class="clear col-sm-3 pull-right pr-0 pl-0">
                       ...
                       <div class="col-sm-6 text-right h-20 line-h-20 pr-0 pl-0">
                           ...
                           <input type="hidden" id="preferentialPrice1" value="${discountPirce}">
                       </div>
                       <div class="col-sm-6 text-right h-20 line-h-20 pr-0 pl-0">
                       ...
                       <div class="col-sm-6 text-right h-20 line-h-20 pr-0 pl-0">
                           ...
                           <input type="hidden" id="postPrice1" value="0.00">
                           <input type="hidden" id="needPost" value="${needPost}">
                       </div>
                       ...
                       <div class="col-sm-6 text-right h-20 line-h-20 pt-20 pr-0 pl-0">
                           ...
                           <input type="hidden" id="actuallyPrice1" value="${actuallyPrice }">
                       </div>
                   </div>
               </div>
    ...
    <script src="<%=request.getContextPath() %>/resources/js/order/en_order.js"></script>
</body>
</html>