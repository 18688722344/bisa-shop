...
<head>
    ...
    <title><spring:message code="name168"/></title>
    <!-- base -->
	            ...
	            <div class="clear pt-20 pl-20 pr-20 bg-f5f5f5 pb-25 mb-40 full-w cur-d">
	                <div class="clear bg-efffe3 pt-40 pb-50">
	                    <div class="clear col-sm-5">
	                        <img class="pull-right" src="<%=request.getContextPath() %>/resources/img/net_shopping/PayError_side.png" alt="">
	                    </div>
	                    <div class="clear col-sm-7 pt-20 pl-40">
	                        <p class="f-26 col-252525 mb-15">
	                           	 <spring:message code="name170"/>
	                        </p>
	                        <p class="f-16 col-252525 mb-15">
	                            	<spring:message code="name171"/><span class="mr-5 ml-5 col-309DE2">
	                            	<spring:message code="name172"/></span>
	                            	<spring:message code="name173"/>
	                        </p>
	                        <p class="f-16 col-252525 mb-15">
	                            	<spring:message code="name174"/>
	                        </p>
	                        <p class="f-16 mb-15">
	                            <a class="col-309DE2 t-nonehove mr-30" href="<%=request.getContextPath() %>/user/orderCenter"><spring:message code="name175"/></a>
