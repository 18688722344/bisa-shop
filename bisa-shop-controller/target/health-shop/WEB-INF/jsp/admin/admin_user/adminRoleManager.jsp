...
<body class="layui-layout-body">
        ...
        <div class="layui-body">
            <div style="padding: 50px;">
                ...
                <div class="clear pd-15 bg-fafafa bor bor-col-e8ebf2">
                    <button type="button" onClick="window.location.href='admin/addAdminRole';" class="layui-btn layui-btn-sm">添加角色</button>
                </div>
                <p class="f-18 pt-15 pb-15 mt-40 col-8d969d">
                    	角色列表
                </p>
                <div class="clear pd-15 bg-fafafa bor bor-col-e8ebf2">
                    <table id="adminRolelist" lay-filter="test"></table>
                </div>
            </div>
        </div>
    ...
    <script src="resources/js/admin/admin_user/adminRoleManager.js"></script>
</body>
</html>